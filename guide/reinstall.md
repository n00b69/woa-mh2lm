...
> [!Note]
> After 1-2 minutes **WINMH2LM** should automatically appear in Windows Explorer. If it does, skip to the "Formatting Windows" step, else continue with the "Diskpart" steps.
