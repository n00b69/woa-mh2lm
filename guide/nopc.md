...
#### Booting to Windows
> If it says "UEFI NOT FOUND", download the [UEFI image](https://github.com/n00b69/woa-mh2lm/releases/tag/UEFI) and place it in the `UEFI` folder in your internal storage.
